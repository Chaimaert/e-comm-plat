    ...
    <section className="about-us p-5">
        <div className="row">
          ...
          <div className="col-md-6 d-flex flex-column align-items-center justify-content-center">
                ...
                <p className="card-text">Noza prides itself on its user-friendly interface, secure payment options, and efficient delivery services, making it a go-to destination for those 
